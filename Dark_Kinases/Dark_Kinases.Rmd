...
krsa_heatmap(data_modeled$scaled %>% 
...
krsa_heatmap(data_modeled$scaled %>% filter(Group == "TNK1") %>% 
               mutate(SampleName = factor(SampleName, 
                                          levels = c("TNK1_250NG_HI", "TNK1_2.5NG", 
                                                     "TNK1_25NG", "TNK1_250NG"))),
...
krsa_heatmap(data_modeled$scaled %>% filter(Group == "EPHA6") %>% 
               mutate(SampleName = factor(SampleName, 
                                          levels = c("EPHA6_250NG_HI", "EPHA6_2.5NG", 
                                                     "EPHA6_25NG", "EPHA6_250NG"))), 
             new_pep, scale = "none", cluster_col = F, annotation_row = pep_annotations)
...
krsa_heatmap(data_modeled$scaled %>% filter(Group %in% c("EPHA6", "TNK1")) %>% 
                mutate(SampleName = factor(SampleName, 
                                          levels = c("TNK1_250NG_HI",
                                                     "TNK1_2.5NG",
                                                     "TNK1_25NG", 
                                                     "TNK1_250NG",
                                                     "EPHA6_250NG_HI","EPHA6_2.5NG",
                                                     "EPHA6_25NG", "EPHA6_250NG")))
...
```{r groupDiff,echo=T, fig.height=8,fig.width=8,fig.align="center", cache=TRUE}
...
```{r heatmapInd,echo=T, fig.align="center", fig.height=8, fig.width=8, cache=TRUE}
...
```{r violinIndPlot,echo=T, fig.align="center", fig.height=8, fig.width=8, cache=TRUE, message=FALSE}
...
```{r waterfall, echo=T, fig.align="center", fig.height=8,fig.width=8, cache=TRUE}
...
```{r krsa, echo=T, warning=F, message=FALSE, fig.align="center", fig.height=8, fig.width=8, cache=TRUE}
...
```{r zscoresPlot, echo=T, warning=F, fig.align="center", fig.height=10,fig.width=8, cache=TRUE}
...
```{r revKRSAPlot, echo=T, warning=F, fig.align="center", fig.height=8, fig.width=8, cache=TRUE}
...
```{r covPlot, echo=T, fig.align="center", fig.height=10,fig.width=8, cache=TRUE}
...
```{r netPlot, echo=T, fig.align="center", fig.height=10,fig.width=8, message=FALSE, cache=TRUE}
